...
from .data.data_readiness import basic_info, create_sub_data_set, data_split, get_data, float_input, limit_num_input, np2pd, num2option, num_input, read_data, show_data_columns
...
def cli_pipeline(training_data_path: str, inference_data_path: Optional[str] = None) -> None:
    ...
    if not training_data_path:
        ...
        file_name = TEST_DATA_OPTION[built_in_data_num - 1]
    ...
    if (not inference_data_path) and is_built_in_data:
        ...
        interface_data_path = TEST_DATA_OPTION[built_in_data_num - 1]
        inference_data = read_data(file_name=interface_data_path)
